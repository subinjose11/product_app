...
//
// List<ProductCategoriesModel> productCategoriesModelFromJson(String str) => List<ProductCategoriesModel>.from(json.decode(str).map((x) => ProductCategoriesModel.fromJson(x)));
//
// String productCategoriesModelToJson(List<ProductCategoriesModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
// @freezed
